...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            #txt_path = os.path.join(os.path.expanduser("~"), "ros_ws", "src", "locosim", "robot_control", "vision", "scripts", "yolov5", "res_save")
            ...
            if len(det):
                ...
                # Write results
                res_save = open(
                    os.path.join(os.path.expanduser("~"), "ros_ws", "src", "locosim", "robot_control", "vision",
                                 "scripts", "yolov5", "res_save.txt"), "w")
                for *xyxy, conf, cls in reversed(det):
                    ...
                    class_index = cls
                    res_save.writelines(f"{x1}, {y1}, {x2}, {y2}, {confidence_score}, {class_index} \n")
